...
export const buttonVariants = cva(
  "font-body transition-all rounded outline-hidden cursor-pointer duration-200 font-medium flex items-center",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "bg-transparent border border-[#1a1a1a]/20 text-[#1a1a1a] transition hover:bg-[#1a1a1a]/5 hover:border-[#1a1a1a]/30",
