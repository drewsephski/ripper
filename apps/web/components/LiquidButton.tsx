...
export default function LiquidButton({
  ...
  return (
    <motion.button
      ...
      className={`relative overflow-hidden bg-[#8b7355] text-white rounded-lg px-4 py-3 font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
      style={{ minHeight: '48px' }}
    >
      {(isHovered || isLoading) && <Liquid isHovered={isHovered} colors={defaultColors} buttonType />}
